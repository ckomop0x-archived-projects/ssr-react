        ...
        <div className="card-deck">
          ...
          <div className="card col-4 cardmin ">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Interim VP Eng. Transforming chaos to clarity. Author, Managing
                the Unmanageable (Addison Wesley).
              </p>
            </div>
          </div>
          ...
          <div className="card col-4 cardmin">
            <img
              className="card-img-top"
              src="/speakers/Speaker-39062.jpg"
            />
            <div className="card-body">
              <a
                href="#"
        ...
        <div className="card-deck">
          ...
          <div className="card col-4 cardmin">
            <div className="card-body">
              ...
              <p className="card-text">
                Managers have critical roles to play enabling agile adoption and
                agile success. While “self-organizing” does not mean no
                managers, the old manager roles and rules no longer apply. This
                session is about manager roles that make agile teams thrive
              </p>
            </div>
          </div>
          ...
          <div className="card col-4 cardmin">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                work and how to do well on them. This will be a deeply technical
                talk covering data structures and algorithms."
              </p>
            </div>
          </div>
        </div>
